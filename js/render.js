	...
	var WaterPolo = function(selector, userOptions) {
		...
		var init = function() {
			...
			(function drawFrame() {
				...
				makeLiquaid(ctx, options.oneOffsetX, options.oneWaveWidth, options.oneWaveHeight,
					options.oneColor);
				makeLiquaid(ctx, options.twoOffsetX, options.twoWaveWidth, options.twoWaveHeight,
					options.twoColor);
